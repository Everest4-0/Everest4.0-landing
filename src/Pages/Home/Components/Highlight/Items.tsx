...
const items: ItemType[] = [
  ...
  },
  {
    ...
    Caption: (
      <>
        <b>
          Programa de Preparação de Consultores Empresariais - Abril de 2024
        </b>
        <br /> <b>Objectivo:</b> " Desenvolvimento de habilidade sobre técnicas
        e ferramentas para prestação de serviços de consultoria em gestão e
        ...
        <ul>
          ...
          <li>
            {" "}
            Estágio profissional na Everest LDA e numa empresa de contabilidade
            (aplicável somente aos 4 melhores participantes);
          </li>
          <li>
            {" "}
            Mentoria individual com consultores financeiros e de investimentos
            (aplicável somente aos 4 melhores participantes)."
          </li>
        </ul>
      </>
